...
* A programming model that defines the structure of an HTML or XML document as a tree of objects, allowing programs (like JavaScript) to access and manipulate the content, structure, and style of a web page.
